...
MIDAS_DIR = "results_rmse/results_rsme_midas"
KALMAN_DIR = "results_rmse/results_rmse_kalman"
...
def main() -> None:
    ...
    table7.to_csv("results_rmse/table_7_final.csv")
    ...
    with open("results_rmse/table_7_final.tex", "w", encoding="utf-8") as f:
        f.write(latex)

    table8 = build_table8(blocks)
    table8.to_csv("results_rmse/table_8_final.csv", index=False)
    ...
    with open("results_rmse/table_8_final.tex", "w", encoding="utf-8") as f:
        f.write(latex8)
